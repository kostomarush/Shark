...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var pcolors = ['#39afd1','#e3eaef','#f24848'];
		var borderColor = '#3b4452';
		var bgColor = '#323a46';
		...
		var pcolorsDot = ['#39afd1','#e3eaef'];
		var borderColorDot = '#3b4452';
		var bgColorDot = '#323a46';
		this.createPlotDotGraph("#website-stats1", uploadsDot, downloadsDot, plabelsDot, pcolorsDot, borderColorDot, bgColorDot);

		//Donut pie graph data
		var donutlabels = ["Bitcoin", "Ethereum", "Litecoin"];
		var donutdatas = [48, 30, 15];
		var donutcolors = ['#39afd1','#33ce7a','#e3eaef'];
		this.createDonutGraph("#donut-chart #donut-chart-container", donutlabels, donutdatas, donutcolors);


		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#f24848']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		//Pie graph data
		var pielabels = ["Bitcoin", "Ethereum", "Litecoin"];
		var datas = [48, 30, 15];
		var colors = ['#39afd1','#6b5eae','#e3eaef'];
		...
		this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#39afd1','#33ce7a','#e3eaef'], ds);
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ['#39afd1','#e3eaef'], line_data);
	},
